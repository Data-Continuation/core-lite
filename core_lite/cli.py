...
def run(repo_root: Path, task_id: str | None = None, skip_tasks: bool = False) -> int:
    ...
    summary = {
        "schema": "stegverse_core_lite_run_summary.v2",
        "context": context,
        "registry_path": str(registry_path),
...
def parse_args() -> argparse.Namespace:
    ...
    run_parser = sub.add_parser("run", help="Refresh registry, fingerprint topology, ingest bundles, and run tasks.")
